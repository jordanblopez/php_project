...
<div class="container">
  ...
  <?php
  $query = $con->query("SELECT a.display_name, a.price, a.size, b.quantity, b.completed, b.order_id FROM products a JOIN orders b ON a.product_id = b.product_id WHERE b.user_id = '".$_SESSION['sessCustomerID']."'ORDER BY b.order_id DESC");
